...
import static com.ondar.bagel.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).stock(DEFAULT_STOCK).price(DEFAULT_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).stock(UPDATED_STOCK).price(UPDATED_PRICE);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).stock(UPDATED_STOCK).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).stock(UPDATED_STOCK).price(UPDATED_PRICE);
