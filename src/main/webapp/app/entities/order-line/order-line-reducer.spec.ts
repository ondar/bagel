...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERLINE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERLINE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERLINE actions', async () => {
      const arg = 42666;
